...
def test_repr():
    """ 
    Test that the __repr__ method properly formats the string.
    """
    calc = Calculation(operation="Modulus", operand1=Decimal("18"), operand2=Decimal("5"))
    assert repr(calc).startswith("Calculation(operation='Modulus', operand1=18, operand2=5, result=3, timestamp=")
