...
class Modulus(Operation):
    ...
    Performs the division of one number by another and returns the remainder.
    """
...
class IntDivision(Operation):
    ...
    Performs the division of one number by another and returns the integer part, discarding the fractional part.
    """
...
class AbsDifference(Operation):
    ...
    Performs the subtraction of one number from another and returns the absolute value.
    """

    def execute(self, a: Decimal, b: Decimal) -> Decimal:
        """
        Subtract one number from another and return the absolute difference.
